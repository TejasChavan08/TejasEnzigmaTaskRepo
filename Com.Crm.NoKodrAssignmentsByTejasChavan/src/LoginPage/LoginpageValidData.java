...
public class LoginpageValidData {
	...
	public static void main(String[] args) throws InterruptedException {
			...
			// login page url
				...
				if (ex_url.equals(ac_url)) {
					...
					driver.findElement(By.xpath("//input[@name='username']")).sendKeys("chavantejas0803@gmail.com");
					
					//getting the password element to insert the element inside the text field (findElement, sendkeys)
					driver.findElement(By.xpath("//input[@name='password']")).sendKeys("Tejas@2001");
