...
public class SignUp_confirm_message {
	...
	public static void main(String[] args) {
		...
		String newPass="Tejas@2001";
		driver.findElement(By.xpath("(//input[@name='password'])[2]")).sendKeys("Tejas@2001");
		
		//for confirm the password
		WebElement conf = driver.findElement(By.name("password-confirmpassword"));
		conf.sendKeys("Tony@20001");
		
		if (newPass.equals(conf.getText())) {
			System.out.println("The confirmation message matches the new password");
		} else {
			System.out.println("The confirmation message does not match the new password");
			System.out.println("Expected: " + newPass);
            System.out.println("Actual: " + conf);
		}
