...
public class SignUp_missingFields {
	...
	public static void main(String[] args) {
		...
		WebElement error_msg=driver.findElement(By.xpath("//h1[@class='slds-text-heading_small slds-p-bottom_xx-small']"));
		
		
		if (error_msg.isDisplayed()) {
			//gettting the message
			WebElement err_message=driver.findElement(By.xpath("//h2[@class='slds-text-heading_small']"));
			
			//displaying the error
			System.out.println(error_msg.getText() +" : "+err_message.getText());
		}	
